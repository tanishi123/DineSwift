                ...
                <div className='add-category-price'>
                    <div className='add-category flex-col'>
                        ...
                        <select name='category' onChange={onChangeHandler} >
                            ...
                            <option value="Rolls Mania">Rolls Mania</option>
                            <option value="Baskin Robbins">Baskin Robbins</option>
                            <option value="Sandwich Junction">Sandwich Junction</option>
                            <option value="Theobrama">Theobrama</option>
                            <option value="Santosham">Santosham</option>
